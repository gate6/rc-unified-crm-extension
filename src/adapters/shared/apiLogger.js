// Shared API logging for all Gate6 connectors ΓÇö consistent, traceable logs for
// future debugging.
//
...
// a failure to the right function. The error interceptor logs the REQUEST body too ΓÇö
